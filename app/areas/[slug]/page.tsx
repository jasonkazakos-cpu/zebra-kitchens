...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      url: `/areas/${loc.slug}`,
      ...(loc.featuredImage && {
        images: [{ url: loc.featuredImage, width: 1200, height: 630, alt: `Zebra Kitchens in ${loc.name}, ${loc.county}` }],
      }),
    },
    twitter: {
      ...
      title: loc.seoTitle,
      description: loc.seoDescription,
      ...(loc.featuredImage && { images: [loc.featuredImage] }),
    },
  };
}
...
export default async function AreaPage({ params }: Props) {
  ...
  const localBusinessLd = {
    ...
    url: `https://www.zebrakitchens.co.uk/areas/${loc.slug}`,
  };
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden bg-ink">
        ...
        <Container className="relative py-16 sm:py-20 lg:py-24">
          ...
          <p className="mt-6 max-w-xl text-base leading-relaxed text-paper/75 sm:text-lg">
            Professional kitchen design, supply and installation in {loc.name} — free quotes, fixed prices, fully insured.
          </p>
      ...
      <section className="bg-paper">
        <Container className="py-16 sm:py-20">
          <div className="lg:grid lg:grid-cols-[1fr_380px] lg:gap-16">
            <div>
              <p className="font-mono text-xs uppercase tracking-[0.2em] text-accent-dark">About This Area</p>
              <h2 className="mt-3 font-display text-3xl font-bold uppercase leading-tight tracking-tight text-ink sm:text-4xl">
                Zebra Kitchens in {loc.name}
              </h2>
      ...
      <section className="bg-chalk">
        <Container className="py-16 sm:py-20">
          <SectionHeading
            ...
            subtitle={`Every Zebra Kitchens service is available in ${loc.name}. Click a service to find out more.`}
          />
      ...
      <section className="bg-paper">
        <Container className="py-16 sm:py-20">
          <SectionHeading
            ...
            title={`Why Homeowners in ${loc.name} Choose Zebra Kitchens`}
        ...
        <Container className="py-16 sm:py-20">
          ...
          <div className="mt-10 grid gap-6 sm:grid-cols-3">
            {[
              ...
              { quote: "The design consultation and survey picked up on things we hadn't thought about. Made the whole project far less stressful.", name: "Local customer", service: "Kitchen Design" },
              { quote: "The worktops look incredible. Couldn't be happier with the finish and the whole process from quote to completion was completely stress-free.", name: "Local customer", service: "Worktops" },
            ].map((t, i) => (
      ...
      <CtaBand
        ...
        subtitle={`Contact Zebra Kitchens today for a free, no-obligation quote on any kitchen project in ${loc.name}.`}
