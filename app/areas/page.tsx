...
export const metadata: Metadata = {
  title: "Areas We Cover | Zebra Kitchens Hertfordshire",
  description:
    "Zebra Kitchens provides kitchen design, supply, installation and worktops across Hertfordshire and surrounding areas. Find your local area.",
};
      ...
      <section className="relative overflow-hidden bg-ink">
        ...
        <Container className="relative py-16 sm:py-20 lg:py-24">
          ...
          <p className="mt-6 max-w-xl text-base leading-relaxed text-paper/75 sm:text-lg">
            Based in {siteConfig.baseTown}, Zebra Kitchens designs, supplies and
            fits kitchens throughout {siteConfig.county} and into neighbouring
            Essex and Middlesex. Select your town below to find out more.
          </p>
        </Container>
      </section>
