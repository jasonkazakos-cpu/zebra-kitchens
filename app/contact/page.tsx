...
export const metadata: Metadata = {
  title: "Contact Us",
  description:
    "Get in touch with Zebra Kitchens for a free, fixed-price quote on kitchen design, supply and installation in Cheshunt and Hertfordshire.",
};
