...
export const metadata: Metadata = {
  title: "Advice & Guides | Zebra Kitchens",
  description:
    "Practical advice on kitchen planning, worktops, costs and choosing a supplier — from the team at Zebra Kitchens in Cheshunt, Hertfordshire.",
  keywords: [
    "Kitchen Planning Guide",
    "Kitchen Fitting Guide",
    "Kitchen Worktop Guide",
    "Kitchen Costs Hertfordshire",
  ],
};
      ...
      <section className="relative overflow-hidden bg-ink">
        ...
        <Container className="relative py-16 sm:py-20">
          ...
          <h1 className="mt-4 max-w-2xl font-display text-4xl font-bold uppercase leading-[0.95] tracking-tight text-paper sm:text-5xl">
            Practical Kitchen Advice From Zebra Kitchens
          </h1>
          <p className="mt-6 max-w-lg text-base leading-relaxed text-paper/75 sm:text-lg">
            Honest guides on planning, worktops and costs — written by the
