  ...
  return (
    <>
        ...
        <Container className="relative grid items-center gap-12 py-16 sm:py-20 lg:grid-cols-2 lg:gap-16">
          <div>
            ...
            <p className="mt-6 max-w-md text-base leading-relaxed text-paper/75 sm:text-lg">
              Expert kitchen fitting services from Zebra Kitchens. With{" "}
      ...
      <section className="bg-paper">
        <Container className="py-16 sm:py-20">
          <SectionHeading
            ...
            subtitle="Real kitchen transformations completed by Zebra Kitchens."
          />
          <div className="mt-10">
      ...
      <section className="bg-chalk">
        <Container className="py-16 sm:py-20">
          <SectionHeading
            ...
            title="Why Choose Zebra Kitchens?"
      ...
      <CtaBand
        ...
        subtitle="Contact Zebra Kitchens today for a free quotation and expert installation service."
