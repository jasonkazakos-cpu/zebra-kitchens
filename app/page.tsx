...
export const metadata: Metadata = {
  title: "Kitchen Design, Supply & Installation in Cheshunt & Hertfordshire",
  description:
      ...
      <section className="bg-paper">
        <Container className="py-16 sm:py-20">
          <SectionHeading
            eyebrow="What We Do"
            title="Our Services"
            subtitle="From a design consultation to a full kitchen fit-out, here's how we can help."
          />
          ...
          <div className="mt-10 flex justify-center">
            <Button href="/kitchens" variant="ghost-dark">
              View All Services
            </Button>
          </div>
        </Container>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            ...
            <div className="flex justify-center lg:justify-start">
              ...
              <img
                ...
                alt="Jason Kazakos, owner of Zebra Kitchens in Cheshunt Hertfordshire"
                loading="lazy"
                decoding="async"
                width={900}
                height={1200}
            ...
            <div>
              ...
              <div className="mt-6 space-y-4 text-sm leading-relaxed text-slate sm:text-base">
                ...
                <p>
                  Whether you need a full kitchen design and installation, a
                  supply-only order or a worktop replacement, every project
                ...
                <p>
                  ...
                  simple: to provide dependable kitchen services with clear
                  communication and fair pricing from start to finish.
                </p>
              </div>
      ...
      <section className="bg-paper">
        <Container className="py-16 sm:py-20">
          <SectionHeading
            ...
            subtitle="Example reviews — a flavour of the feedback we aim for on every kitchen."
          />
          <div className="mt-10">
      ...
      <section className="bg-chalk">
        <Container className="flex flex-col items-center gap-5 py-16 text-center sm:py-20">
          ...
          <p className="max-w-xl text-base leading-relaxed text-slate sm:text-lg">
            Follow Zebra Kitchens on Facebook to see our latest kitchen
            installations, customer projects, before and after photos and
            company updates.
          </p>
          <a
