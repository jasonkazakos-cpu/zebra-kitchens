    ...
    <section className={bg}>
      <Container className="py-16 sm:py-20">
        ...
        <div className="relative mx-auto mt-12 aspect-square w-full max-w-[300px] sm:max-w-[420px]">
          ...
          <div className="absolute left-1/2 top-1/2 flex -translate-x-1/2 -translate-y-1/2 flex-col items-center justify-center rounded-full bg-ink px-3 py-3 text-center shadow-[0_12px_30px_-10px_rgba(31,35,40,0.45)] sm:px-5 sm:py-5">
